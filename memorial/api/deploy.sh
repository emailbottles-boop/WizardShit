...
for col in "kind TEXT NOT NULL DEFAULT 'photo'" "mime TEXT NOT NULL DEFAULT ''" "duration REAL NOT NULL DEFAULT 0" "photographer TEXT NOT NULL DEFAULT ''" "thumb_key TEXT NOT NULL DEFAULT ''" "original_key TEXT NOT NULL DEFAULT ''" "original_bytes INTEGER NOT NULL DEFAULT 0" "trimmed INTEGER NOT NULL DEFAULT 0" "pre_key TEXT NOT NULL DEFAULT ''" "pre_thumb_key TEXT NOT NULL DEFAULT ''" "pre_width INTEGER NOT NULL DEFAULT 0" "pre_height INTEGER NOT NULL DEFAULT 0" "pre_bytes INTEGER NOT NULL DEFAULT 0" "pre_mime TEXT NOT NULL DEFAULT ''"; do
